...
public interface PaymentRepository extends JpaRepository<Payment, String> {
    ...
    // realizaron algún pago en 2008. Tenga en cuenta que deberá eliminar aquellos
    ...
    // Consulta 13
    @Query("SELECT p.total FROM Payment p WHERE p.wayToPay = 'Paypal' AND FUNCTION('YEAR', p.paymentDate) = 2008")
    List<Double> findPaypalPaymentsTotalIn2008();
    ...
    // Suma total de todos los pagos que se realizaron para cada uno de los años que
